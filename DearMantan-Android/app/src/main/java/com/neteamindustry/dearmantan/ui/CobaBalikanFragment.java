 ...
 */
public class CobaBalikanFragment extends ListGridFragment<Item>  {

    private Datasource<Item> datasource;


    public static CobaBalikanFragment newInstance(Bundle args) {
        CobaBalikanFragment fr = new CobaBalikanFragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.cobabalikan_item;
    }
